...
export default function AdminAuditLog() {
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-700 p-1">
            ...
            {/* Advanced Filters */}
            <Card className="relative overflow-hidden bg-white/80 dark:bg-card/40 backdrop-blur-xl border-[#f0e8e2] dark:border-[#f0e8e2] shadow-xl shadow-black/5 rounded-[32px] py-4">
                <CardContent className="p-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6 items-end">
                        <div className="space-y-2.5">
                            <Label className="text-[11px] font-bold uppercase tracking-widest text-slate-500 dark:text-muted-foreground ml-1">Search Module</Label>
                        ...
                        <div className="space-y-2.5">
                            <Label className="text-[11px] font-bold uppercase tracking-widest text-slate-500 dark:text-muted-foreground ml-1">Action Type</Label>
                            <Select value={filters.action} onValueChange={(v) => handleFilterChange("action", v)}>
                                <SelectTrigger className="mt-2 h-12 rounded-xl border-[#f0e8e2] dark:border-[#f0e8e2] bg-slate-50 dark:bg-muted/50 transition-all font-medium">
                                    <SelectValue placeholder="All Actions" />
                                </SelectTrigger>
                                <SelectContent className="bg-white/95 dark:bg-card/95 backdrop-blur-xl border-[#f0e8e2] dark:border-[#f0e8e2]">
                        ...
                        <div className="space-y-2.5">
                            <Label className="text-[11px] font-bold uppercase tracking-widest text-slate-500 dark:text-muted-foreground ml-1">Principal User</Label>
                        ...
                        <div className="space-y-2.5">
                            ...
                            <Input
                                type="date"
                                className="mt-2 h-12 rounded-xl border-[#f0e8e2] dark:border-[#f0e8e2] bg-slate-50 dark:bg-muted/50 transition-all font-medium px-4"
                    ...
                    <CardContent className="p-0">
                            ...
                            <Table>
                                <TableHeader className="bg-slate-50 dark:bg-white/[0.02] border-b border-slate-100 dark:border-[#f0e8e2]">
                                    <TableRow className="hover:bg-transparent border-none">
                                        <TableHead className="w-[180px] text-black dark:text-foreground text-[10px] font-bold uppercase tracking-widest py-5 pl-8">Timestamp</TableHead>
                                        <TableHead className="text-black dark:text-foreground text-[10px] font-bold uppercase tracking-widest py-5">Principal User</TableHead>
                                        <TableHead className="text-black dark:text-foreground text-[10px] font-bold uppercase tracking-widest py-5">Global Action</TableHead>
                                        <TableHead className="text-black dark:text-foreground text-[10px] font-bold uppercase tracking-widest py-5">System Module</TableHead>
                                        <TableHead className="text-black dark:text-foreground text-[10px] font-bold uppercase tracking-widest py-5">Entity ID</TableHead>
                                        <TableHead className="text-black dark:text-foreground text-[10px] font-bold uppercase tracking-widest py-5">Network IP</TableHead>
                                        <TableHead className="text-right text-black dark:text-foreground text-[10px] font-bold uppercase tracking-widest py-5 pr-8">Actions</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
                                    {logs.map((log, i) => (
                                        <TableRow key={i} className="group hover:bg-slate-50 dark:hover:bg-white/[0.02] transition-all duration-300 border-b border-slate-100 dark:border-[#f0e8e2] last:border-none">
                                            ...
                                            <TableCell>
                                                <div className="flex items-center gap-3">
                                                    <div className="h-8 w-8 rounded-xl bg-slate-100 dark:bg-muted flex items-center justify-center text-[10px] font-bold border border-[#f0e8e2]/50 dark:border-[#f0e8e2] shadow-inner">
                                            ...
                                            <TableCell className="capitalize text-xs font-bold text-slate-600 dark:text-muted-foreground">
                        ...
                        {loading && (
                            <div className="p-20 text-center animate-pulse">
                                <LogoLoader />
                                <p className="text-xs font-bold uppercase tracking-[0.2em] text-muted-foreground mt-8">Decrypting audit trail...</p>
                            </div>
                        )}
                        ...
                        {!loading && logs.length === 0 && (
                            <div className="p-32 text-center">
                                <div className="h-20 w-20 rounded-[32px] bg-slate-50 dark:bg-white/5 flex items-center justify-center mx-auto mb-8 shadow-inner">
                                    <ClipboardList className="h-10 w-10 text-slate-200 dark:text-foreground/10" />
                                </div>
                                <p className="text-sm font-bold text-muted-foreground uppercase tracking-widest">No audit logs identified</p>
                        ...
                        {!loading && logs.length > 0 && logs.length >= total && (
                            <div className="p-8 text-center border-t border-slate-100 dark:border-[#f0e8e2] bg-slate-50/50 dark:bg-white/[0.01]">
                                <p className="text-[10px] font-black text-muted-foreground tracking-[0.3em] uppercase">SYSTEM TRAIL COMPLETE • {total} RECORDS SECURED</p>
                            </div>
                        )}
                    </CardContent>
                </Card>
                    ...
                    <div className="flex-1 overflow-y-auto p-10 space-y-10 scrollbar-premium">
                        {loadingDetails ? (
                            <div className="py-20 text-center animate-pulse">
                                <LogoLoader />
                                <p className="text-xs font-bold uppercase tracking-[0.2em] text-muted-foreground mt-8">Assembling audit data...</p>
                            </div>
                        ) : (details && selectedLog) ? (
                            <div className="space-y-10">
                                ...
                                <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
                                    <div className="space-y-2">
                                        <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground mx-3">Action Type</Label>
                                    ...
                                    <div className="space-y-2">
                                        <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-1">Principal User</Label>
                                        <p className="font-extrabold text-sm text-slate-700 dark:text-slate-200 ml-1">{selectedLog?.performed_by}</p>
                                    </div>
                                    <div className="space-y-2">
                                        <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-1">System Module</Label>
                                    ...
                                    <div className="space-y-2">
                                        <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-1">Network Origin</Label>
                                ...
                                <div className="space-y-5">
                                    <div className="flex items-center justify-between px-1">
                                        ...
                                        <Badge className="bg-slate-100 dark:bg-white/5 text-slate-500 dark:text-muted-foreground border-none text-[9px] font-black uppercase tracking-widest">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        {(!details.audit_log_events || details.audit_log_events.length === 0) && (
                                            <div className="p-8 rounded-[32px] bg-slate-50 dark:bg-white/[0.01] border border-dashed border-[#f0e8e2] dark:border-[#f0e8e2] text-center">
                                                <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest italic">No detailed property transformations identified.</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between px-1">
                                        <Label className="text-[11px] font-bold uppercase tracking-widest text-muted-foreground">Technical Context Snapshot</Label>
                                    ...
                                    <div className="rounded-[32px] bg-background dark:bg-black p-8 border border-[#f0e8e2] text-[10px] leading-relaxed overflow-x-auto shadow-2xl relative group/code">
